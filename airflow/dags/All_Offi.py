...
with DAG(
    ...
    complete_bronze = PythonOperator(
    task_id="complete_bronze_layer",
    python_callable = lambda: print("processing bronze layer complete"),
    dag=dag
)
    

    complete_silver = PythonOperator(
    task_id="complete_silver_silver",
    python_callable = lambda: print("processing silver layer complete"),
    dag=dag
)
    

    complete_gold = PythonOperator(
